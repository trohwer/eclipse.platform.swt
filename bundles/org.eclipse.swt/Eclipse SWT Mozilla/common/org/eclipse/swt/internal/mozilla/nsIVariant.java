...
public class nsIVariant extends nsISupports {
	...
	public int GetAsArray(short[] type, long /*int*/ iid, int[] count, long /*int*/[] ptr) {
		return XPCOM.VtblCall(nsISupports.LAST_METHOD_ID + ((IsXULRunner10() || IsXULRunner24() || IsXULRunner31()) ? 25 : 24), getAddress(), type, iid, count, ptr);
	}

	public int GetAsWStringWithSize(int[] size, long /*int*/[] str) {
		return XPCOM.VtblCall(nsISupports.LAST_METHOD_ID + ((IsXULRunner10() || IsXULRunner24() || IsXULRunner31()) ? 27 : 26), getAddress(), size, str);
	}
}
